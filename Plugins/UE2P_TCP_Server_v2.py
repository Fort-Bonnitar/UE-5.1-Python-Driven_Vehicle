...
class driver_agent:
    ...
    def get_throttle(self, front_trace, left_trace, right_trace, current_speed):
        ...
        vehicle_inputs = np.array([[front_trace, left_trace, right_trace, current_speed]])
        throttle = self.throttling_model.predict(vehicle_inputs)
...
##############################################################################################################
        ...
        driver = driver_agent('./content/ModelFiles/ue5_throttle_model.bak', './content/ModelFiles/ue5_dir_model.bak')
